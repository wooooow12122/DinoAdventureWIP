...
public class ClawLivingEntityIsHitWithToolProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				DinoanimatronicMod.LOGGER.warn("Failed to load dependency entity for procedure ClawLivingEntityIsHitWithTool!");
			return;
		}
