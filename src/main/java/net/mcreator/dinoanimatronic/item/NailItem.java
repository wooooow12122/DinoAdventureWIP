...
public class NailItem extends DinoanimatronicModElements.ModElement {
	@ObjectHolder("dinoanimatronic:nail")
	public static final Item block = null;

	public NailItem(DinoanimatronicModElements instance) {
		super(instance, 9);
	}
